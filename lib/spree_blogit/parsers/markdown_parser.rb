class SpreeBlogit::Parsers::MarkdownParser

  require "nokogiri"
  require "spree_blogit/renderers"
  ...
  def parsed
    ensure_pygments_is_installed if SpreeBlogit::configuration.highlight_code_syntax
  ...
  def renderer
    if SpreeBlogit::configuration.highlight_code_syntax
      SpreeBlogit::Renderers.choose_highlight_renderer
    else
  ...
  def markdown
    @markdown ||= Redcarpet::Markdown.new(renderer,
      SpreeBlogit.configuration.redcarpet_options)
  end
