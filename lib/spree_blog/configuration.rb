module SpreeBlog
  ...
  #  config/initializers/blog.rb with all of the default configurations applied.
  #
  ...
  class Configuration
    ...
    #     blog_warn "You've set config.disqus_shortname in your blog config file but " \
    ...
    # Print a warning message to $STDOUT with the prefix "[blog]: "
    #
    # Examples
    #
    #  blog_warn("blog is not a toy!")
    #  # => "[blog]: blog is not a toy!"
    #
    def blog_warn(message)
      warn "[blog]: #{message}"
    end
