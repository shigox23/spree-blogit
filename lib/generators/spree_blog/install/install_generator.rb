  ...
  module Generators
    class InstallGenerator < Rails::Generators::Base
      ...
      def add_javascripts
        ...
        append_file 'vendor/assets/javascripts/spree/frontend/all.js', "//= require bootsy\n"
        append_file 'vendor/assets/javascripts/spree/backend/all.js', "//= require bootsy\n"
      end
      ...
      def add_stylesheets
        ...
        inject_into_file 'vendor/assets/stylesheets/spree/frontend/all.css', " *= require bootsy\n", :before => /\*\//, :verbose => true
        inject_into_file 'vendor/assets/stylesheets/spree/backend/all.css', " *= require bootsy\n", :before => /\*\//, :verbose => true
      end
